...
import 'package:loanapp/src/widgets/custom_animated_size_widget.dart';
...
class _CustomTextFormFieldState extends State<CustomTextFormField> {
  ...
  Widget build(BuildContext context) {
    ...
    contentPadding = widget.contentPadding ?? EdgeInsets.symmetric(horizontal: getScreenWidth(8.0), vertical: getScreenHeight(4.0));
        ...
        Focus(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: !error
                  ? widget.hintStyle ?? TextStyle(color: Theme.of(context).colorScheme.primary.withValues(alpha: 0.5))
                  : widget.errorStyle ??
              ...
              enabledBorder:
                  widget.enabledBorder?.copyWith(borderSide: BorderSide(width: 1, color: widget.enableBoderColor ?? Theme.of(context).colorScheme.primary.withValues(alpha: 0.5))) ??
                      OutlineInputBorder(
                        borderRadius: borderRadius,
                        borderSide: BorderSide(width: 1, color: Theme.of(context).colorScheme.surface.withOpacity(0.5)),
                      ),
              focusedBorder: widget.focusedBorder?.copyWith(borderSide: BorderSide(width: 1, color: widget.focusBoderColor ?? Theme.of(context).colorScheme.primary)) ??
                  OutlineInputBorder(
                    borderRadius: borderRadius,
                    borderSide: BorderSide(width: 1, color: Theme.of(context).colorScheme.background),
                  ),
              errorBorder: widget.errorBorder?.copyWith(borderSide: BorderSide(width: 1, color: Theme.of(context).colorScheme.error)) ??
                  OutlineInputBorder(
                    borderRadius: borderRadius,
                    borderSide: BorderSide(width: 1, color: Theme.of(context).colorScheme.error),
                  ),
              focusedErrorBorder: widget.focusedErrorBorder
                      ?.copyWith(borderSide: BorderSide(width: 1, color: Theme.of(context).colorScheme.primary.withOpacity(0.5))) ??
                  OutlineInputBorder(
                    borderRadius: borderRadius,
                    borderSide: BorderSide(width: 1, color: Theme.of(context).colorScheme.primary.withOpacity(0.5)),
                  ),
              disabledBorder:
                  widget.disabledBorder?.copyWith(borderSide: BorderSide(width: 1, color: Theme.of(context).colorScheme.primary.withOpacity(0.1))) ??
                      OutlineInputBorder(
                        borderRadius: borderRadius,
                        borderSide: BorderSide(width: 1, color: Theme.of(context).colorScheme.primary.withOpacity(0.1)),
                      ),
            ),
          ),
        ),
